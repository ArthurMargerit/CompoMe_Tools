...
public:
  ...
  using T_p_stream = std::tuple<AccessData_fake_stream*,CompoMe::Fake_stream*,AccessData*>;
  using T_p_dbus = std::tuple<AccessData_fake_dbus*,CompoMe::Fake_dbus*,AccessData*>;
  ...
  {return std::make_tuple<AccessData_fake_dbus*,CompoMe::Fake_dbus*,AccessData*>(nullptr, nullptr, nullptr);}
  ...
  virtual CompoMe::Config::Result_state add(CompoMe::String key,CompoMe::String value)=0;
  virtual CompoMe::Config::Result_state set(CompoMe::String key,CompoMe::String value)=0;
