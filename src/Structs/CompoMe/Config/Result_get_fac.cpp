...
Result_get_fac::Result_get_fac() { this->init(); }

Result_get_fac::~Result_get_fac() {}

CompoMe::Config::Result_get *
Result_get_fac::build(const std::string &p_type, std::istream &p_stream,
...
std::shared_ptr<CompoMe::Config::Result_get>
Result_get_fac::build_sp(const std::string &p_type, std::istream &p_stream) {
...
void Result_get_fac::init() {
  ...
  CompoMe::Serializable_fac::Build_fac_f f =
      [](const std::string &str, std::istream &p_s,
        ...
        return dynamic_cast<CompoMe::Serializable_Item *>(
            Result_get_fac::get_inst().build(str, p_s, l_ctx));
      };
  ...
  CompoMe::Serializable_fac::get_inst().subscribe("CompoMe::Config::Result_get",
                                                  f, f_sp);
}

void Result_get_fac::subscribe(const std::string &ss, Build_fac_f v,
                               Build_fac_f_sp v_sp) {
