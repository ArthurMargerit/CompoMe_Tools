...
class AccessData_fake_stream : public CompoMe::Config::AccessData,
                               public CompoMe::Fake_stream {
public:
  // constructor
  AccessData_fake_stream(CompoMe::Function_stream_send &out,
  ...
  //   return dynamic_cast<CompoMe::Config::AccessData*>(new
  //   CompoMe::Config::AccessData_fake(os,is));
  // }
