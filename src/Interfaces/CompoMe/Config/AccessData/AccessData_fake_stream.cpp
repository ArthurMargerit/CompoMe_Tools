...
AccessData::get_fake_stream(CompoMe::Function_stream_send &fs,
  ...
  std::tuple<AccessData_fake_stream*,
             CompoMe::Fake_stream*,
               AccessData*> rr(a, a, a);
  return rr;
}

AccessData_fake_stream::AccessData_fake_stream(CompoMe::Function_stream_send& out, CompoMe::Return_stream_recv& in):
...
// INTERFACE Function AccessData ////////////////////////////////////////////////
  ...
  CompoMe::Config::Result_state AccessData_fake_stream::add(CompoMe::String key,CompoMe::String value)
  {
    this->get_o().start();
    this->get_o() << "add("
    << key<< ","<< value<< ")";
  ...
  CompoMe::Config::Result_state AccessData_fake_stream::set(CompoMe::String key,CompoMe::String value)
  {
    this->get_o().start();
    this->get_o() << "set("
    << key<< ","<< value<< ")";
