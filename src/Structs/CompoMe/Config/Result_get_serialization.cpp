...
std::istream& Result_get::from_stream(std::istream& is, CompoMe::Serialization_context_import& p_ctx) {
  Result_get l_reset;
  *this = l_reset;
...
std::ostream& Result_get::to_stream(std::ostream& os, CompoMe::Serialization_context_export& p_ctx) const {
  os << "{" ;
  os << "addr:" << (void*) this;
  p_ctx.declare(this);
